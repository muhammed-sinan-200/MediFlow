...
const Doctors = () => {
  ...
  useEffect(() => {
    applyFilter()
  }, [doctors, selectedSpeciality, searchDoc])
    ...
    <div className='pb-20'>
      ...
      >
        ...
        <select
          ...
          className='w-full border border-gray-300 rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-purple-400 cursor-pointer'
        >
      ...
      <div className='w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pt-6'>
        {filterDoctor.length > 0 ? (
          ...
          <p className='text-center text-purple-700 col-span-full py-10'>
            No doctors found for {searchDoc}
          </p>
        )}
      </div>
    </div>
